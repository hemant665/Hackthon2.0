    ...
    <div className="p-4">
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {images.map((src, index) => (
          <div
            key={index}
            className={`overflow-hidden  rounded-lg shadow-md cursor-pointer ${[0, 4, 6,10,12,15,19,21].includes(index) ? "lg:col-span-2" : ""}
`}
      ...
      {isOpen && (
        <div
          className="fixed   inset-0 bg-black/75 text-white flex items-center justify-center z-50"
